            ...
            <div className="modal">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        ...
                        <input value={form.username} onChange={e=>setForm({...form, username: e.target.value})} required placeholder="e.g. John Doe" />
                    </div>
                    <div className="form-group">
                        <label>Email Address</label>
                        <input type="email" value={form.email} onChange={e=>setForm({...form, email: e.target.value})} required placeholder="john@clubab.com" />
                    </div>
                    <div className="form-group">
                        <label>Password</label>
                        <div style={{ position: 'relative' }}>
                            <input type={showPassword ? "text" : "password"} value={form.password} onChange={e=>setForm({...form, password: e.target.value})} required placeholder="Min 8 characters" minLength={8} style={{ paddingRight: '40px' }} />
...
export function UserManagement() {
    ...
    return (
        <div>
            ...
            <div className="card">
                <h3 style={{ marginBottom: 20 }}>Workspace Accounts</h3>
