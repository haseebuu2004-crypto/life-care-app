...
- Name: 03-dashboard-math.spec.js >> Phase 1: Dashboard Math Verification >> DB Integrity: Dashboard Revenue matches sum of price_charged
- Location: tests\03-dashboard-math.spec.js:11:3
...
Call log:
  - Expect "toHaveURL" with timeout 15000ms
    30 × unexpected value "http://localhost:3001/login"
